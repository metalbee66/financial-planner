...
See [tasks/plan.md](../tasks/plan.md). Phase 3 complete pending Checkpoint D (two-user smoke test). Still ahead: per-project views (list/timeline/calendar), cross-project views, **email notifications via n8n + M365 Outlook**, celebrations, local AI helpers, and final retirement of the PM DLBooks tab.
