...
See [tasks/plan.md](../tasks/plan.md). Still ahead in Phase 3: file attachments, milestone flag. Then per-project views (list/timeline/calendar), cross-project views, **email notifications via n8n + M365 Outlook**, celebrations, local AI helpers, and final retirement of the PM DLBooks tab.
